...
test.describe('Dashboard - Analytics', () => {
  test('Overview Analytics Visibility and Retrieval', async () => {
    ...
    const payIns = await page.getByText('PayIns 1,500.00');
    ...
    const payOuts = await page.getByText('PayOuts 1,005,400.00');
    ...
    const clients = await page.getByText('Clients 0');
    ...
    const users = await page.getByText('Users 0');
