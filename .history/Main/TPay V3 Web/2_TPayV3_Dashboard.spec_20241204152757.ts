...
test.describe('Dashboard - Analytics', () => {
  test('Overview Analytics Visibility and Retrieval', async () => {
    ...
    const totalPayIns = await page.locator('#payins-total', { timeout: 20000 }); // Wait up to 10 seconds
    ...
    const totalPayOuts = await page.locator('#payouts-total', { timeout: 20000 }); // Wait up to 10 seconds
