...
test.describe('Dashboard - Analytics', () => {
  test('Overview Analytics Visibility and Retrieval', async () => {
    await page.getByText('PayIns:').click();
    await page.getByText('2,505.00')
    await page.getByRole('link', { name: 'Today' }).first()
    await page.getByRole('link', { name: 'Last 7 days' }).nth(1)
    await page.getByRole('link', { name: 'Last 30 days' })
    await page.getByRole('link', { name: 'Last 3 months' })
