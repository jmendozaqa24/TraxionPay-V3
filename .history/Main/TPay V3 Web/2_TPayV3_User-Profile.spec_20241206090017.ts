...
test.describe('TPay V3 - User Profile', () => {
  test('User Profile', async () => {
    ...
    const kycStatus = await page.locator('text=KYC Status:').locator('..').locator('span').textContent() || 'N/A';
    const personCode = await page.locator('text=Person Code:').locator('..').locator('span').textContent() || 'N/A';
