...
test.describe('Dashboard - User Details', () => {
  test('User Details Visibility', async () => {
    // Check visibility of the account link
    ...
    // Check visibility of the current currency link
    ...
    console.log('Current currency link is visible.');

    // Check visibility of the available currency link
    ...
    console.log('Available currency link is visible.');

    // Check visibility of the heading (assuming it's the first heading in a specific section)
    ...
    console.log('Checking visibility of the "+" button...');
    const plusButton = await page.getByText('+');
    await expect(plusButton).toBeVisible();
    console.log('The "+" button is visible.');

    // Check visibility of the email link (assuming it's the first link in a specific section)
    console.log('Checking visibility of the email link...');
    const emailLink = await page.getByRole('link', { name: /@traxiontech.net/ });
    await expect(emailLink).toBeVisible();
    console.log('Email link is visible.');

    // Check visibility of the QR code image (assuming it's the first image in a specific section)
    ...
    // Check visibility of the phone number (assuming it follows the format +63123456789)
