...
test.describe('Dashboard - Analytics', () => {
  test('Overview Analytics Visibility and Retrieval', async ({ page }) => {
    ...
    const totalPayIns = await page.getByText('link', { name: /PAYINS/ }); // Adjust the regex to match the format of the PayIns value
