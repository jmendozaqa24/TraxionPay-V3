...
test('User Details Visibility', async () => {
  await page.getByRole('link', { name: 'Account: 1011-4445-9187-' }).click();
  await page.getByRole('link', { name: 'Current: PHP' }).click();
  await page.getByRole('link', { name: 'Available: PHP' }).click();


  await page.getByRole('heading', { name: '1011-4445-9187-3006' }).click();

  await page.getByText('+').click();

  await page.getByRole('link', { name: 'ejarcena03@traxiontech.net' }).click();
