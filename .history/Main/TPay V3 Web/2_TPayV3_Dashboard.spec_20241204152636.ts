...
test.describe('Dashboard - Analytics', () => {
  test('Overview Analytics Visibility and Retrieval', async () => {
    ...
    const totalPayIns = await page.waitForSelector('#payins-total', { timeout: 10000 }); // Wait up to 10 seconds
    ...
    const totalPayOuts = await page.waitForSelector('#payouts-total', { timeout: 10000 }); // Wait up to 10 seconds
