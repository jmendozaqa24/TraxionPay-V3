...
test.describe('TPay V3 - User Profile', () => {
    test('User Profile', async () => {
        ...
        await page.getByText('Birth Date: Not Set').click();
        await page.getByText('Birth Place: Not Set').click();
        await page.getByText('Gender: Not Set').click();
        await page.getByText('Civil Status: Not Set').click();
        await page.getByText('Nationality: Not Set').click();

        //User Details
        await page.getByText('User Details').click();
        await page.getByText('7E5A79EE-C8A0-4F3F-AE65-').click();
        await page.getByText('User Level:').click();
        await page.getByText('Role Name: Merchant Admin').click();
        ...
        await page.getByText('Wallet Code: TP-20240925-').click();
        ...
        await page.getByText('Verification Status: Verified').click();
        await page.getByText('Scope: Registered').click();
        ...
        await page.getByText('Value: ejarcena03@traxiontech').click();
