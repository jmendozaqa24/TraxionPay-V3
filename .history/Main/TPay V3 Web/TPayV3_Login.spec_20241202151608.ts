...
await page.getByText('Email address').toBeVisible()();
await page.getByPlaceholder('your@email.com').click();

await page.getByText('Email address Mobile Number').toBeVisible();
await page.getByPlaceholder('Your mobile number').click();