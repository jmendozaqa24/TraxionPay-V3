...
test.describe('Dashboard - Analytics', () => {
  test('Overview Analytics Visibility and Retrieval', async () => {
    ...
    test('Transaction Chart Visibility and Retrieval', async () => {
      ...
      const yAxisLabels = await page.locator('#div:nth-child(2) > .col-lg-12 > .card > .card-body').filter({ hasText: /^[0-9]+$/ });
      ...
      const xAxisLabels = await page.locator('#div:nth-child(2) > .col-lg-12 > .card > .card-body').filter({ hasText: /^\d{4}-\d{2}-\d{2}$/ });
      ...
      const barGraphs = await page.locator('#div:nth-child(2) > .col-lg-12 > .card > .card-body');
