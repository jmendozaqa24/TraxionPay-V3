...
await page.getByText('Bank Name: ASIA UNITED BANK').click();
await page.getByText('Account Name: Vincent Salanga').first().click();
await page.getByText('Account Number: 916100010416').click();
await page.getByText('Account Type: Savings').click();