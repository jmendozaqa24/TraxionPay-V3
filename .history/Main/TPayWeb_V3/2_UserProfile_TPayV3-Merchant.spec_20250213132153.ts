...
test.describe.serial('User Profile', () => {
  ...
  test('User Profile - Profile Tab', async () => {  
  ...
  test('User Profile - My Account Tab', async () => {
  ...
  test('User Profile - Merchant Details Tab', async () => {
  ...
  test('User Profile - Bank Accounts Tab', async () => {
    test.setTimeout(60000); // Increase timeout to 60 seconds
