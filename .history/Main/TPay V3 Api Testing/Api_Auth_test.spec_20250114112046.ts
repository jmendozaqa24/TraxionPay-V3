...
test.describe.parallel('API Testing', () => {
  ...
  test('WhoAmI', async ({ request }) => {
    ...
    const otp = getEnvVariable('generated_totp_code'); // Retrieve the new OTP from the environment variables
    ...
    const decryptedResponse = decryptResponse(responseBody, otp);
