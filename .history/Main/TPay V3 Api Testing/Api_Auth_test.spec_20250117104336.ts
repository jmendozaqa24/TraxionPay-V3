...
test.describe.parallel('API Testing - Login', () => {
  ...
  test('Login', async ({ request }) => {
    test.info().annotations.push({ type: 'description', description: 'This test logs in a user and stores the tokens in environment variables.' });
  ...
  test('Logout', async ({ request }) => {
    test.info().annotations.push({ type: 'description', description: 'This test logs out a user and clears the tokens from environment variables.' });
...
test.describe.parallel('API Testing - WhoAmI', () => {
  ...
  test('WhoAmI', async ({ request }) => {
    test.info().annotations.push({ type: 'description', description: 'This test retrieves the current user information using the WhoAmI endpoint.' });
  ...
  test('WhoAmI with invalid token', async ({ request }) => {
    test.info().annotations.push({ type: 'description', description: 'This test attempts to retrieve user information with an invalid token.' });
  ...
  test('WhoAmI with expired token', async ({ request }) => {
    test.info().annotations.push({ type: 'description', description: 'This test attempts to retrieve user information with an expired token.' });
  ...
  test('WhoAmI multiple times', async ({ request }) => {
    test.info().annotations.push({ type: 'description', description: 'This test runs the WhoAmI endpoint multiple times to calculate the average response time.' });
...
test.describe.parallel('API Testing - Refresh Tokens', () => {
  ...
  test('Refresh-Token', async ({ request }) => {
    test.info().annotations.push({ type: 'description', description: 'This test refreshes the tokens using the refresh token endpoint.' });
